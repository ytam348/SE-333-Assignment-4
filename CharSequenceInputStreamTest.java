...
//        at org.apache.commons.io.input.CharSequenceInputStream.fillBuffer(CharSequenceInputStream.java:111)
    ...
    @Test
    public void skipTestZero() throws Exception {
        try (InputStream r = new CharSequenceInputStream("test", "US-ASCII")) {
            assertEquals(0, r.skip(0));//testing the and because n is 0
            r.read();
            r.read();
            r.read();
            r.read();
            assertEquals(0, r.skip(1));//testing the and because available is 0
            assertEquals(0, r.skip(0));//testing the or because both are 0
