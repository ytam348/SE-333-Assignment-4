...
public class DemuxTestCase {
    ...
    @Test
    public void testInputStreamNull() throws Exception{
        final DemuxInputStream input = new DemuxInputStream();
        startReader(T1, DATA1, input);
        startReader(T2, DATA2, input);
        startReader(T3, DATA3, input);
        ...
        doStart();
        doJoin();
        assertNotNull("Null return",getInput(T1));
        assertNotNull("Null return", getInput(T2));
        assertNotEquals("Null return", getInput(T3));
        assertNotEquals("Null return", getInput(T4));
    }
