...
public class ReaderInputStreamTest {
    ...
    @Test
    public void testReadCharBoundary() throws Exception{
        final String inStr = "test";
        try(final ReaderInputStream r = new ReaderInputStream(new StringReader(inStr))){
            final byte[] bytes = new byte[30];
            assertNotEquals(0, r.read(bytes, -1, -1));
        } catch (Exception e) {
            assertTrue(e.toString().contains("Array Size="));
